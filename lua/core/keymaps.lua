...
--[[  Going to use mine instead of this one.  Might come back to this...
    ["<Up>"] = {
      cmd = ":tabnew<CR>",
      desc = "New tab",
    },
...
--]]
    ["<Up>"] = {
      cmd = "gk",
      desc = "Go up screen line, not logical line",
    },

    ["<Down>"] = {
      cmd = "gj",
      desc = "Go down screen line, not logical line",
    },
...
--[[
    ["W"] = {
      cmd = "w",
      desc = "Shift Key Fixes in command mode",
    },
